  ...
  return (
    <div className="container mx-auto py-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-4xl font-bold">Pustaka Saya</h1>
      </div>
      ...
      {libraryNovels.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center text-center py-20 bg-secondary/30 rounded-lg">
          ...
          <p className="text-muted-foreground mb-6">Tambahkan novel ke pustaka untuk membacanya nanti.</p>
          <Link href="/">
            <Button>Jelajahi Novel</Button>
          </Link>
        </div>
      )}
    </div>
